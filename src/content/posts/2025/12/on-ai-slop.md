...
This sits inside a broader problem. AI models are producing large amounts of boring, verbose, low-effort, LAZY content, and it is steadily flooding the web. Others, like [Kurzgesagt](https://www.youtube.com/watch?v=_zfN9wnPvU0) or [Last Week Tonight](https://www.youtube.com/watch?v=TWpg1RmzAbc), have explored this more publicly, but the pattern is easy to recognise once you've seen it a few times.

I am not against AI-generated content. It can be genuinely useful. 
I use it for drafts, quick exploration, and grammar checks. With some of my juniors, I even encourage generating bad code with AI and reviewing it together. All my blog posts go through an LLM to catch obvious mistakes, even though **every single word is written by me**. And yes, the cover is from [ChatGPT Images](https://openai.com/index/new-chatgpt-images-is-here/), I think it did a great job.
...
There is [an extensive list of common signs of AI-generated writing on Wikipedia](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing), which is worth reading.
...
AI tools are getting better: [the latest ChatGPT version even removed the infamous em dashes](https://www.pcmag.com/news/you-can-now-stop-chatgpts-em-dash-fixation-heres-how). That does not change your responsibility to review what they produce.
