---
title: "Microsoft, Copilot, and how to add friction"
date: 2026-07-09
...
I was watching with deep sadness [the thousands of layoffs that Microsoft has announced](https://blogs.microsoft.com/blog/2026/07/06/the-latest-in-our-company-transformation/) in the past days, and [the backlash when they removed Claude licenses for their own workers instead of using Copilot](https://www.theverge.com/tech/930447/microsoft-claude-code-discontinued-notepad), wondering how much things have changed in the past 3 years.

I remember when in 2023 we started using [Bing, non-ironically, because it had GPT-4 integrated into the AI search](https://www.teamblind.com/post/mindblown-at-bing-chatgpt-integration-httzssqu). Its market share was rising, and Microsoft, thanks to its partnership with OpenAI, was really riding the AI wave.
...
The more powerful model is not the point. 
Let's focus on making it work **frictionless** with your users, gaining trust, and showing that AI can really provide help.