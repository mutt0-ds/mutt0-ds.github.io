---
title: La Scienza Delle Pulizie
...
- ⭐ Focus on where to use them. Most transmission occurs, in order:
  ...
  1. Eating with unwashed hands
  1. Using toilets or changing a diaper
  1. Coughing/sneezing
  1. Other (in order: surfaces touched by a sick person, contaminated laundry, animals, trash, other infected people)
...
- ⭐ Classic clogged drain: this happens because solid residues build up in the pipe (often food). In extreme cases you need a plumber (there must be at least a trickle of water; if totally blocked avoid forcing it). Before that, try in this order (ignore bad advice online; do not use baking soda):
  ...
  1. A couple of liters of hot water around 60 C to dissolve solidified grease
  1. Caustic soda (sodium hydroxide) for protein residues; many drain openers use this
  1. A plunger if it is still clogged
